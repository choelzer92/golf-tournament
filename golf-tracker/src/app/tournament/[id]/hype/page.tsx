  ...
  matchups: [
    {
      ...
      playerB: 'Enterlin',
      handicapB: '4.6',
      callout: 'The alpha match. Bodner gets 2 strokes over 9 holes. That\'s it. Two shots against the best player in the field and he thinks that\'s enough. Enterlin is a 4.6 who hits every fairway and doesn\'t flinch over 4-footers. Bodner has the length to overpower this course but one loose tee shot and Jake is standing in the fairway with a wedge in his hand while you\'re hacking out of the trees. Two strokes disappear fast when you\'re scrambling. Jake - you better close this out because if an 8-handicap takes you down with only 2 shots, that\'s going to follow you.',
    },
    {
      playerA: 'Ross',
      handicapA: '21',
      playerB: 'Casey',
      handicapB: '12.8',
      callout: 'Ross gets about 4 strokes over 9 holes. Four holes where a bogey becomes a net par. Four holes where Casey has to beat him clean with no safety net. But here\'s the thing - Casey doesn\'t make doubles. Casey doesn\'t hand you holes. He pars his way around a golf course and waits for you to beat yourself. Ross - those 4 strokes are your entire margin. Piss away even one of them with a blow-up hole and you\'re playing from behind against a guy who never gives anything back. Casey - everyone thinks this is your match to lose. How tight does your chest get when you bogey 13 and suddenly he\'s all square with you?',
    },
    {
      playerA: 'Smith',
      handicapA: '10.7',
      playerB: 'Hoelzer',
      handicapB: '9.6',
      callout: 'Effectively scratch against each other. Maybe one stroke over 9 holes. Maybe zero. No handicap edge, no built-in excuse, no "well he was getting shots." This is a bare-knuckle 9-hole fight between two guys who both think they\'re the better player. Whoever loses this match has to look across the table at dinner knowing the other guy just proved them wrong in front of everyone. No hiding from this result. One of you is going to have to live with it.',
    },
    {
      playerA: 'Burns',
      handicapA: '15.5',
      playerB: 'Lacy',
      handicapB: '11',
      callout: 'Burns gets 2 strokes. Two extra chances to halve a hole he has no business halving. Lacy is the better golfer and everyone in both groups knows it. But 9-hole match play is a different animal - it\'s short enough that anything can happen and long enough that you can\'t get lucky for all of it. Lacy - you\'re supposed to handle this. Your team is counting on these points. If Burns catches fire for 4 holes and you\'re sitting there 2 down with 3 to play, that\'s on you. Burns - nobody expects you to win this match. Use that. Play free. Make him feel every single one of those 2 strokes.',
    },
  ],
  closer: {
