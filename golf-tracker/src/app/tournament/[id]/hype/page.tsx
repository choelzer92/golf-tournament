  ...
  matchups: [
    {
      ...
      playerB: 'Enterlin',
      handicapB: '4.6',
      callout: 'The alpha match. Bodner thinks he can go toe-to-toe with the best player in the field. Enterlin\'s giving up 3-4 strokes and still expects to win. One of these guys is delusional. Nine holes to find out which one. Bodner - those strokes won\'t mean anything if you can\'t handle the speed of Glenmore\'s greens. Jake - you\'re giving shots to an 8.5 who\'s been waiting months for this. Don\'t get comfortable.',
    },
    {
      playerA: 'Ross',
      handicapA: '21',
      playerB: 'Casey',
      handicapB: '12.8',
      callout: 'Ross gets a stroke on damn near every hole. He needs them. Casey is the kind of player who pars his way through a round and never gives you anything. He doesn\'t beat himself. Ross - your strokes mean nothing if you\'re carding double bogeys. Casey - you\'re supposed to win this. Everyone expects you to win this. How\'s that feel standing over a 5-footer on 16 knowing your team is counting on it?',
    },
    {
      playerA: 'Smith',
      handicapA: '10.7',
      playerB: 'Hoelzer',
      handicapB: '9.6',
      callout: 'The coin flip. Basically identical handicaps. No edge. No built-in excuse for either side. This comes down to who shows up that day and who doesn\'t. Whoever loses this match can\'t blame the format, can\'t blame the strokes, can\'t blame anything but themselves. That\'s going to sting.',
    },
    {
      playerA: 'Burns',
      handicapA: '15.5',
      playerB: 'Lacy',
      handicapB: '11',
      callout: 'Burns gets shots. Lacy\'s the better golfer. On paper this is Lacy\'s to lose - which is exactly the kind of pressure that makes guys spray one into the trees on 12. Burns - you\'re the underdog. Nobody expects you to win. That\'s dangerous. Lacy - if you drop this match to a guy getting 4 strokes, your team is going to have questions.',
    },
  ],
  closer: {
